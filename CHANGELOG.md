...
- fixing log message ([@kharrop](https://github.com/kharrop))
...
- fixing implementation for tests ([@kharrop](https://github.com/kharrop))
- trying to fix logs ([@kharrop](https://github.com/kharrop))
